...
public class StudentManagement3 {
	...
	/*public void printStudent(int index) {
		...
		System.out.println("이름 : " + studentlist.students[index].getName());
		System.out.println("학년 : " + studentlist.students[index].getGrade());
		System.out.println("평균 : " + studentlist.students[index].getAverage());
		System.out.println("점수: " + studentlist.students[index].getScore());
		System.out.println("--------------------------------");
	}*/
	...
	public void searchStudent() {
		...
		for (int i = 0; i < studentlist.size(); i++) {
			...
			String name = studentlist.students[i].getName();
